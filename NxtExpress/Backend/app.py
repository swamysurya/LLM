...
# means that any client from any domain can make requests to this Flask application without being blocked by the browser's same-origin policy.
#  This is particularly useful for APIs that are intended to be accessed by web applications hosted on different domains.
CORS(app)
